...
class LazySegmentTree:
    ...
    def build(self, idx: int, left_element: int, right_element: int, a: list[int]) -> None:
    ...
    def update(self, idx: int, left_element: int, right_element: int, a: int, b: int, val: int) -> bool:
        if self.flag[idx]:
    ...
    def query(self, idx: int, left_element: int, right_element: int, a: int, b: int) -> int | float:
        if self.flag[idx]:
            self.segment_tree[idx] = self.lazy[idx]
            self.flag[idx] = False
            if left_element != right_element:
