...
class TestDiophantineEquation(unittest.TestCase):
    ...
    def test_diophantine_all_soln(self):
        ...
        self.assertListEqual(diophantine_all_soln(10, 6, 14, 2), expected_output_1)
        self.assertListEqual(diophantine_all_soln(10, 6, 14, 4), expected_output_2)
        self.assertListEqual(diophantine_all_soln(391, 299, -69, 4), expected_output_3)
