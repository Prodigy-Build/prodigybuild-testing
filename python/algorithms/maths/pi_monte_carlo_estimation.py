...
class TestPiMonteCarloEstimation(unittest.TestCase):
    def test_estimate_pi(self):
        self.assertAlmostEqual(estimate_pi(1000), pi, places=2)
        self.assertAlmostEqual(estimate_pi(10000), pi, places=2)
        self.assertAlmostEqual(estimate_pi(100000), pi, places=2)
        self.assertAlmostEqual(estimate_pi(1000000), pi, places=2)
        self.assertAlmostEqual(estimate_pi(10000000), pi, places=2)
