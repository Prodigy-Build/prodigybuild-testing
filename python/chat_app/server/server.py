...
class TestServer(unittest.TestCase):
    ...
    def test_get_just_name(self):
        ...
        self.server.client_map[client1] = ("address1", "name1", "public_key1")
        self.server.client_map[client2] = ("address2", "name2", "public_key2")
        self.server.client_map[client3] = ("address3", "name3", "public_key3")
        
        self.assertEqual(self.server.get_just_name(client1), "name1")
        self.assertEqual(self.server.get_just_name(client2), "name2")
        self.assertEqual(self.server.get_just_name(client3), "name3")
    ...
    def test_get_address(self):
        ...
        self.assertEqual(self.server.get_address(client1), "address1")
        self.assertEqual(self.server.get_address(client2), "address2")
        self.assertEqual(self.server.get_address(client3), "address3")
    
    def test_send_encrypted(self):
        recipient1 = socket.socket()
        recipient2 = socket.socket()
        recipient3 = socket.socket()
        
        self.server.client_map[recipient1] = ("address1", "name1", RSA.importKey("public_key1"))
        self.server.client_map[recipient2] = ("address2", "name2", RSA.importKey("public_key2"))
        self.server.client_map[recipient3] = ("address3", "name3", RSA.importKey("public_key3"))
        
        self.assertEqual(self.server.send_encrypted(recipient1, "message1", "sender1"), None)
        self.assertEqual(self.server.send_encrypted(recipient2, "message2", "sender2"), None)
        self.assertEqual(self.server.send_encrypted(recipient3, "message3", "sender3"), None)
    ...
    def test_join_room(self):
        ...
        self.server.join_room(sock1, "-join room1")

        self.assertEqual(self.server.rooms, {"room1": ["user1", "user1"]})
        self.assertEqual(self.server.room_map, {"room1": [UserMap(sock1, "user1"), UserMap(sock1, "user1")]})
    ...
    def test_leave_room(self):
        ...
        self.server.leave_room(sock1, "user1", "room1")

        self.assertEqual(self.server.rooms, {"room1": []})
        self.assertEqual(self.server.room_map, {"room1": []})
    ...
    def test_create_room(self):
        ...
        self.server.create_room(sock1, "-create room1")

        self.assertEqual(self.server.rooms, {"room1": ["user1"]})
        self.assertEqual(self.server.room_map, {"room1": [UserMap(sock1, "user1")]})
