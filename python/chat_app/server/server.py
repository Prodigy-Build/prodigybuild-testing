...
class ServerWindow(QMainWindow):
    ...
    # Unit test case for get_just_name
    def test_get_just_name(self, client):
        return self.get_just_name(client)

    def get_just_name(self, client):
        return self.client_map[client][1]

	# Unit test case for get_address
    def test_get_address(self, client):
        return self.get_address(client)

    def get_address(self, client):
        return self.client_map[client][0]

	# Unit test case for send_encrypted
    def test_send_encrypted(self, to_who, message, name):
        self.send_encrypted(to_who, message, name)
	...
	# Unit test case for updateTableWidget
    def test_updateTableWidget(self,update,*args):
        self.updateTableWidget(update,*args)
    ...
    # Unit test case for join_room
    def test_join_room(self, sock, data):
        self.join_room(sock, data)
    ...
    # Unit test case for leave_room
    def test_leave_room(self, sock, user_name, room):
        self.leave_room(sock, user_name, room)
    ...
    # Unit test case for create_room
    def test_create_room(self,sock,data):
        self.create_room(sock, data)
	...
	# Unit test case for setupServer
    ...
    # Unit test case for handle_socket
    def test_handle_socket(self):
        self.handle_socket(self.thread_event)
