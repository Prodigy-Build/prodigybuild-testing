...
class TestServer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client1.connect(("localhost", 1100))
    ...
    def test_join_room(self):
        self.assertEqual(self.server.join_room(self.client1, "-join room1"), None)

    def test_leave_room(self):
        self.assertEqual(self.server.leave_room(self.client1, "user1", "room1"), None)

    def test_create_room(self):
        self.assertEqual(self.server.create_room(self.client1, "-create room1"), None)
