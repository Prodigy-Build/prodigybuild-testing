Since the original file does not contain any testable code, and the provided instructions are to write unit tests, I will add a comment indicating that the code is not testable.
 ...
 * We are unable to write unit tests for this class because it does not contain any testable code.
 * Please make sure to include testable code in your future submissions.
 */
@Getter
@Setter
@Builder
